...
export const SPELLS = [
  ...
  // ---- Acquired blade arts ----
  { id: 'thunder',   name: 'Cross-Slash', icon: '⚡', type: 'magic', target: 'enemy', power: 42, mpCost: 24, cooldown: 1.0, speed: 44, splash: 1.6, element: 'thunder', unlock: 'kill2',
    description: 'A crackling cross-shaped slash that arcs into foes.' },
  { id: 'drain',     name: 'Siphon Strike', icon: '🩸', type: 'drain', target: 'enemy', power: 30, mpCost: 22, cooldown: 1.2, speed: 24, splash: 0, element: 'dark', unlock: 'kill4',
    description: 'A cursed edge that steals the life of what it cuts.' },
  { id: 'meteor',    name: 'Blade Beam', icon: '💥', type: 'magic', target: 'enemy', power: 70, mpCost: 50, cooldown: 1.7, speed: 22, splash: 3.6, element: 'fire', unlock: 'kill6',
    description: 'A massive energy wave loosed from your blade.' },
  { id: 'cure2',     name: 'Full Cure', icon: '➕', type: 'heal', target: 'self', power: 95, mpCost: 42, cooldown: 5, element: 'holy', unlock: 'kill9',
    description: 'Channel a surge of vitality — a big instant heal.' },
  { id: 'blizzard',  name: 'Frost Cyclone', icon: '🌀', type: 'magic', target: 'enemy', power: 60, mpCost: 40, cooldown: 1.5, speed: 22, splash: 3.2, element: 'ice', unlock: 'kill12',
    description: 'A spinning storm of ice blades. (Cryo units absorb it!)' },
  { id: 'holy',      name: 'Lightbringer', icon: '🔆', type: 'magic', target: 'enemy', power: 58, mpCost: 55, cooldown: 2.2, speed: 40, splash: 2.4, element: 'holy', unlock: 'kill15',
    description: 'A searing beam of holy light that cleaves armor.' },
  { id: 'ultima',    name: 'Omnislash', icon: '⚔️', type: 'magic', target: 'enemy', power: 150, mpCost: 80, cooldown: 2.5, speed: 30, splash: 4.5, element: 'dark', unlock: 'bossDefeated',
